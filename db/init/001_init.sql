...
CREATE TABLE pets (
    ...
    energy NUMERIC(6, 3) NOT NULL DEFAULT 0.000,
    curiosity NUMERIC(6, 3) NOT NULL DEFAULT 0.000,
    sociality NUMERIC(6, 3) NOT NULL DEFAULT 0.000,
    routine NUMERIC(6, 3) NOT NULL DEFAULT 0.000,
