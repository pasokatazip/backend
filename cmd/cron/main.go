...
func main() {
	...
	log.Printf("cron started: report notification runs every day at %02d:00 %s", reportHour, location.String())
	runDaily(ctx, location, reportHour, func(runCtx context.Context) {
